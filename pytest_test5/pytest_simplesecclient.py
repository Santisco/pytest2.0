...
class EchoClientProtocol(asyncio.Protocol):
    ...
    def data_received(self, data):
        ...
        f = open("security_response_" + str(FILE_NUM), 'r+')
        f.read()
        f.write("    securitydata:" + data.decode())
        f.close()
    ...
    def connection_lost(self, exc):
        ...
        self.loop.stop()
while True:
    f = open("security_response_" + str(FILE_NUM), 'w')
    f.write("timestamp:" + str(time.time()) + "     senddata:" + CLIENT_MESSAGE)
    f.close()
